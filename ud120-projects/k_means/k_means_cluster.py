...
import sys
sys.path.append("E:/Udacity/ud120-projects/tools/")
...
with open("E:/Udacity/ud120-projects/final_project/final_project_dataset_unix.pkl", "rb") as f:
    ...
    #data_dict = pickle.load(open("E:/Udacity/ud120-projects/final_project/final_project_dataset.pkl", "rb"))
...
import numpy as np
stockList = data[:,1]
minval = np.min(stockList[np.nonzero(stockList)])
maxval = np.max(stockList[np.nonzero(stockList)])
